...
run_analysis <- function(){
    ...
    X_test <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/test/X_test.txt")
    y_test <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/test/y_test.txt")
    subject_test <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/test/subject_test.txt")
    
    #create tables from *train.txt files
    X_train <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/train/X_train.txt")
    y_train <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/train/y_train.txt")
    subject_train <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/train/subject_train.txt") 
    
    #create tables for features and activity labels
    features <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/features.txt")
    activity_labels <- read.table("C:/Users/Austin/Documents/datasciencecoursera/UCI HAR Dataset/activity_labels.txt")
